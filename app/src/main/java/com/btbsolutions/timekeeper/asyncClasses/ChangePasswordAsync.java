...
public class ChangePasswordAsync extends AsyncTask<String, Void, String> {
    ...
    public ChangePasswordResponse delegate = null;

    public ChangePasswordAsync(Context mContext) {
    ...
    protected void onPostExecute(String s) {
        ...
        delegate.changePasswordProcessFinish(s);
    }

    @Override
    protected String doInBackground(String... strings) {
        String useremail = strings[0];
        String temppass = strings[1];
        String password = strings[2];
        StringBuilder result = new StringBuilder();
        try {

            //private String login_url = "http://10.0.2.2/DBConnections/login.php";
            String login_url = "http://tpandedeveloper.000webhostapp.com/dbconnection/changepassword.php";
            ...
            String post_data = URLEncoder.encode("useremail", "UTF-8") + "=" + URLEncoder.encode(useremail, "UTF-8") + "&"
                    + URLEncoder.encode("temppass", "UTF-8") + "=" + URLEncoder.encode(temppass, "UTF-8") + "&"
